#Given a sorted (inc order) array with unique int elems, create a BST with minimal height
#from sorted array we are taking middle as root recursively for left, right etc
